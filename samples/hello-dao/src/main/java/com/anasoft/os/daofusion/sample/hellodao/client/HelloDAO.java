...
public class HelloDAO implements EntryPoint {
    ...
    public static final String DAO_FUSION_HOME = "http://opensource.anasoft.sk/daofusion-site/";
    ...
    public void onModuleLoad() {
        ...
        refresh.addClickHandler(new ClickHandler() {
            public void onClick(ClickEvent event) {
                // ListGrid caches previously fetched
                // data on the client automatically
